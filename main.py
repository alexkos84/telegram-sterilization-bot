...
class SimpleChannelParser:
    ...
    def extract_contact(self, text: str) -> str:
        ...
        if usernames:
            contacts.extend([f"<a href='https://t.me/{u[1:]}'>{u}</a>" for u in usernames[:2]])
            ...
            return [
                {
                    ...
                    'contact': '<a href="https://t.me/volunteer1">@volunteer1</a> • <a href="tel:+79781234567">+7 978 123-45-67</a>',
            ...
            return [
                {
                    ...
                    'contact': '<a href="https://t.me/dog_volunteer">@dog_volunteer</a> • <a href="tel:+79787654321">+7 978 765-43-21</a>',
...
📱 <b>Социальные сети:</b>
🔹 Telegram: <a href="https://t.me/yalta_animals">@yalta_animals</a>
🔹 Instagram: <a href="https://instagram.com/yalta_street_animals">@yalta_street_animals</a>"""
...
🤝 <b>Стать волонтером:</b>
Пишите <a href="https://t.me/animal_coordinator">@animal_coordinator</a>"""
